...
export const LeftSideData: RibbonType[] = [
    ...
    },
    {
        ...
        ribbonText: '40% OFF',
        subText: <p>Edge <em className="txt-danger">ribbon </em>among the most often used <em className="txt-danger">ribbon styles is CSS.</em>{" This design's author provides you with a short piece of code that has room for several optional components_source and effects."}</p>
    },
    {
