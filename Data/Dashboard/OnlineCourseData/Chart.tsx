...
export const todayProgressData: ChartOptionType = {
    series: [38, 60],
    options: {
        chart: {
            width: 240,
...
export const LearningOverviewChartData: ChartOptionType = {
    series: [
        {
            name: 'growth',
            type: 'line',
...
export const ActivityHoursChartData: ChartOptionType = {
    series: [
        {
            name: 'Activity',
...
export const UpcomingOptionsChartData: ChartOptionType = {
    series: [
        {
            data: [
                {
...
export const LessonChartOption: ChartOptionType = {
    series: [],
